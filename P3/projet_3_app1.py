...
def deg_to_mercator(dico_coord):
    ...
    for k in dico_coord.keys():
        ...
        for lon, lat in dico_coord[k][1]:
            ...
            #nouvelle coordonnée projetée et ajustée
    ...
    #dictionnaire et bornes globales
...
#Calcul du centre des données (point de pivot de la carte)
...
for k,v in dico_coord_screen.items() :
        fltk.polygone(v, couleur='black', remplissage=random.choice(["red", "orange", "yellow", "green", "blue", "indigo", "violet"]), epaisseur=1)
fltk.attend_ev()